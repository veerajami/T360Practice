...
public class TestCases extends Controller{
	...
	String matter_name="temp matter9";
	...
	@Test(priority=1,description="Test Case ID:0001")
	public void createMatterTest(){
		...
		MatterPropertiesPage matterpropertiespage=mattercreationworkflowpage.addMatter(matter_name,workarea,matter_start_date , mattercreationworkflowpage);
		Assert.assertTrue(matterpropertiespage.validateMatterName(matter_name));
	}
	
	@Test(priority=2,description="Test Case ID:0001")
